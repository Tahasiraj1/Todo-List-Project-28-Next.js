...
export default function TodoList() {
    ...
    return (
        ...
        style={{
            backgroundImage: `url('/bg/todo.jpg')`,
        ...
        >
            <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
                ...
                <div className="flex items-center mb-4">
                    ...
                    className="flex-1 mr-2 px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:text-gray-200"
                    />
                    <Button
                    onClick={addTask}
                    className="bg-black hover:bg-slate-800 text-white font-medium rounded-md"
                    >
                        Add
                    </Button>
                </div>
                        ...
                        >
                            ...
                            <div className="flex items-center">
                                {editingTaskId === task.id ? (
                                    ...
                                    className="bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500 text-gray-800 dark:text-gray-200 font-medium py-1 px-2 rounded-md mr-2"
                                    >
                                        Edit
                                    </Button>
                                )}
